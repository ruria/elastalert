...
+--------------------------------------------------------------+           |
| ``run_date_format`` (string, default "%d/%m/%y)              |           |
+--------------------------------------------------------------+-----------+
...
example: running rule all days from 00:00:00 to 01:00:00 and mondays + fridays from 13:00:00 to 20:00:00 except first and second of january 2017
...
Specifies date format for `exclude`` property of ``run_time`` (default "%d/%m/%Y")
